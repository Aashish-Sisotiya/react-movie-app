...
export default class Favourite extends Component {
  ...
  render() {
    console.log(movies.results[1].genre_ids[2]);
    let genreids = {
      28: 'Action', 12: 'Adventure', 16: 'Animation', 35: 'Comedy', 80: 'Crime', 99: 'Documentary', 18: 'Drama', 10751: 'Family', 14: 'Fantasy', 36: 'History',
      27: 'Horror', 10402: 'Music', 9648: 'Mystery', 10749: 'Romance', 878: 'Sci-Fi', 10770: 'TV', 53: 'Thriller', 10752: 'War', 37: 'Western'
    };
            ...
            <div className='row'>
              <div className='col-lg-3 col-sm-12 '>
                <ul className="list-group favourites-geners">
                  {
                    this.state.genres.map((genere) => (
                      this.state.currgen === genere ?
                        <li className="list-group-item" style={{ background: '#3f51b5', color: 'white', fontWeight: 'bold' }}>{genere}</li> :
                        <li className="list-group-item" style={{ background: 'white', color: '#3f51b5' }} onClick={() => this.handleGenereChange(genere)}>{genere}</li>
                    ))
                  ...
                  <table className="table">
                    <thead>
                      <tr>
                        ...
                        <th scope="col"><i class="fa-solid fa-sort-up" onClick={this.sortPopularityDesc}></i>Popolarity<i class="fa-solid fa-sort-down" onClick={this.sortPopularityAsen}></i></th>
                        <th scope="col"><i class="fa-solid fa-sort-up" onClick={this.sortRatingDesc} ></i>Rating<i class="fa-solid fa-sort-down" onClick={this.sortRatingAsen}></i></th>
